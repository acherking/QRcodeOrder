...
class AuthenticationsControllerTest < ActionController::TestCase
  ...
  test "should create authentication" do
    assert_difference('Authentication.count') do
      post :create, authentication: { authentication_str: @authentication.authentication_str, statu: @authentication.statu, table_id: @authentication.table_id }
    end
  ...
  test "should update authentication" do
    patch :update, id: @authentication, authentication: { authentication_str: @authentication.authentication_str, statu: @authentication.statu, table_id: @authentication.table_id }
    assert_redirected_to authentication_path(assigns(:authentication))
  end
